...
namespace vae {
	...
	*/
	void VvtCamera::setOrthographicProjection(
	...
	canonical view volume.
	*/
	void VvtCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far) {
	...
	*/
	void VvtCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	*/
	void VvtCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		setViewDirection(position, target - position, up);
	}

	void VvtCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
